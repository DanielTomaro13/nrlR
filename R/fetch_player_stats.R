...
fetch_player_stats_championdata <- function(comp, round = NULL) {
  ...
  # Create a "home" version
  fixtures_home <- fixtures[, c("matchId", "competition_id", "roundNumber",
                                "homeSquadId", "homeSquadName",
                                "matchStatus", "utcStartTime")]
  ...
  # Create an "away" version
  fixtures_away <- fixtures[, c("matchId", "competition_id", "roundNumber",
                                "awaySquadId", "awaySquadName",
                                "matchStatus", "utcStartTime")]
  ...
  # Combine into a long-format fixture dataset
  fixtures_long <- dplyr::bind_rows(fixtures_home, fixtures_away)

  joined <- dplyr::left_join(
    player_stats,
    fixtures_long[, c("matchId", "competition_id", "squadId", "roundNumber",
                      "fixture_team_name", "team_location",
                      "matchStatus", "utcStartTime"), drop = FALSE],
    by = c("match_id" = "matchId", "competition_id", "squadId")
  )
